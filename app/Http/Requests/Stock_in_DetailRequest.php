...
class Stock_in_DetailRequest extends FormRequest
{
    /**
    ...
    public function messages(): array
    {
        return [
            ...
            'stock_in_id.required' => 'Field stock_in_id wajib diisi.',
            'stock_in_id.exists' => 'Stock_in dengan ID yang dipilih tidak valid.',
